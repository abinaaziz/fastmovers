        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\Staff\\DailyWorkers\\";
                    Random r=new Random();
            ...
            String columns="staffCategoryID,firstName,dailyWages,commission,address,postbox,place,"
                    + "pincode,email,aadarNumber,contactNumber,"
                    + "mobileNumber,profilePicture";  
            
            String queryInsert="insert into tbl_daily_workers("+columns+") values ("+values1+")";
