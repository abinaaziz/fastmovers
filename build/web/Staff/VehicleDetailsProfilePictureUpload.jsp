        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\Staff\\Vehicles\\";
                    Random r=new Random();
            ...
            String columns="vehicleCategoryID,vehicleNumber,perKmCharge,commission,company,modelName,"                   
            + "profilePicture";  
            
            String queryInsert="insert into tbl_vehicle_details("+columns+") values ("+values1+")";
