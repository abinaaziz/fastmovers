...
<div class="div_login">
    ...
    <body>
        ...
        String URLfishID=request.getParameter("fishID");
        ...
        {           
            String queryDelete="delete from tbl_fish_details where fishID="+did;
            ...
            response.sendRedirect("FishDetails.jsp?fishID="+URLfishID);
        }
        
        if (eid != null)
        {   
            hid=request.getParameter("hid");
            String querySelect="select * from tbl_fish_details where fishID="+eid;
            System.out.print("EDIT: eid="+eid);
            ResultSet rs=obj.select(querySelect);                
            if(rs.next())
            { 
                fishName =rs.getString("fishName");
                actualRate =rs.getString("actualRate");
                sellingRate =rs.getString("sellingRate");
                seedSize =rs.getString("seedSize");
        ...
        {               
            ...
            seedSize =request.getParameter("seedSize");
            discription =request.getParameter("discription");
           
            String values1="'"+fishName 
            +"','"+actualRate
            +"','"+sellingRate
            +"','"+seedSize
            +"','"+discription
            ...
            if (request.getParameter("eid") != null)
            {
                ...
                String values2="fishName='"+fishName                
                + "',actualRate='" +actualRate
                + "',sellingRate='" +sellingRate
                + "',seedSize='" +seedSize
                + "',discription='" +discription
                +"'";         
                String queryUpadate = "update tbl_fish_details set "+values2+ " where fishID=" + eid;  //EDIT
                System.out.print(queryUpadate);
                obj.executeCommand(queryUpadate);
            } 
            else  
            {                    
                String columns= " fishName, actualRate, sellingRate, seedSize, discription";
                String queryInsert="insert into tbl_fish_details("+columns+") values ("+values1+")";
           ...
           <td>   
               <table class="Content_Table" >
                  ...
                  <tr>
                       ...
                       <td>
                          <input type="text" name="fishName" requird="" value="<%=fishName%>"> 
                       </td> 
                   </tr>
                   <tr>
                       <td>
                  ...
                  <tr><td>seedSize</td>
                      <td>
                             <input type="text" name="seedSize" requird="" value="<%=seedSize%>">  </td></tr>   

                  <tr><td>Fish Description</td>
                      <td>
                         ...
                         <h2>Fish Details </h2>
                                ...
                                <tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="align-content: center; width:350px;">
                                                    Fish ID:  <%=rs.getString("a.fishID")%>
                                                 </td>
                                            </tr>
                                            <tr>
                                                <td style="align-content: center; width:350px;">
                                                    Fish:  <%=rs.getString("a.fishName")%>
                                                 </td>
                                            </tr>
                                    ...
                                    <td style="vertical-align: middle">
                                        <div style="font-size: 20px;"> <font color="#0847a8">  RS:  <%=rs.getString("a.seedSize")%>
                                    </td>
                                    <td  style="width: 80px;"><a href="FishDetails.jsp?eid=<%=rs.getString("a.fishID")%>&fishID=<%=URLfishID%>"><img src="../TemplateStyleFiles/EditIcon.png" height="30px" width="30px"></a></td>
                                    <td  style="width: 80px;"><a href="FishDetails.jsp?did=<%=rs.getString("a.fishID")%>&fishID=<%=URLfishID%>"><img src="../TemplateStyleFiles/DeleteIcon.png" height="30px" width="30px"></a></td>
                                </tr>
