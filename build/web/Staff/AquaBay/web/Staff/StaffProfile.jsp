...
<html>
    ...
    <body class="backgroungPicture1">
        ...
        while (rs1.next()) 
        {
            ...
            divition=rs1.getString("divition");
        ...
        if (request.getParameter("buttonSubmit")!=null)
        {
            ...
            divition=request.getParameter("divition");
    ...
    <form name="Form1" method="POST"> 
        <div align="center" >        
            <table class="Content_Table" >
               ...
               <tr><td>DIVISION</td>
                   <td>
                          <select name="divition" >
                             <option>Select</option>
                               <%
                               String selectQuery1="select * from tbl_divition";
                               ResultSet rs=obj.select(selectQuery1);
                               while (rs.next())
                               {                                                                                                                        
                               %>
                               <option value="<%=rs.getString("divitionID")%>" <%if(divition.equals(rs.getString("divitionID"))){%> selected="select"<%}%> >
                                <%=rs.getString("divitionName")%>
                               </option> 
               ...
               <tr>               
                   <td>GENDER</td>
                   <td>            
                   <input type="radio" name="gender" requird="" value="male" > Male
                   <input type="radio" name="gender" requird="" value="female" checked=""> Female</td></tr>
