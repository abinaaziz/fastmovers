...
<head runat="server">
    ...
    {        
        String queryInsert="insert into tbl_payments(pondID,payedAmount,payedDate)"
        + "values('"+URLpondID+"','"+URLadvance+"','"+currentDate+"')";
        System.out.print(">>>>>>> DATA TO ORDER HEAD insertQuery1 :"+queryInsert);
        obj.executeCommand(queryInsert);
        
        String queryUpadate="update tbl_pond_register set  status=2 WHERE pondID="+URLpondID;              
