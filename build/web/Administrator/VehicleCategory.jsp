...
<html>
    ...
    if(request.getParameter("B_Submit")!=null)  //Submit Button Code -Checking the url passed argument named "edit" is null on not.
    {
        ...
        if(request.getParameter("edit")!=null)
        {
            ...
            String queryUpadate="update tbl_vehicle_category set vehicleCategoryName='"+TValue1+"' where vehicleCategoryID="+GetURLVal1;
            obj.executeCommand(queryUpadate);
        
        }
        else
        {
            String queryInsert="insert into tbl_vehicle_category(vehicleCategoryName)values('"+TValue1+"')";
            obj.executeCommand(queryInsert); //Reload the same page or refresh the same page
        }
        response.sendRedirect("VehicleCategory.jsp");
    }
    
    if(request.getParameter("delete")!=null)  //Delete Button Code
    {
        GetURLVal1=request.getParameter("URLVal1"); 
        String queryDelete="delete from tbl_vehicle_category where vehicleCategoryID="+GetURLVal1;
    ...
    <tr>
        <td>
            <div align="center" >         
                ...
                <tr >
                    <th class="a">VEHICLE CATEGORIES</th>
                    ...
                    <th class="a b"> DELETE</th>
                                ...
                                <%
                                    String V1="";
                                    String V2="";   
                                    String querySelect="select * from tbl_vehicle_category ORDER BY vehicleCategoryName";
                                    ResultSet rs=obj.select(querySelect);
                                    while(rs.next())
                                    {
                                        V1=rs.getString("vehicleCategoryID");
                                        V2=rs.getString("vehicleCategoryName");
                                %>
                                
                                <tr>
                                    <td><% out.print(V2); %></td>
                                    <td style="width: 80px;"><a href="VehicleCategory.jsp?edit=1&URLVal1=<% out.print(V1); %>&URLVal2=<% out.print(V2);%>"><img src="../TemplateStyleFiles/EditIcon.png" height="30px" width="30px"/></a></td>
                                    <td style="width: 80px;"><a href="VehicleCategory.jsp?delete=1&URLVal1=<% out.print(V1); %>"><img src="../TemplateStyleFiles/DeleteIcon.png" height="30px" width="30px"/></a></td>
                                 </tr>
