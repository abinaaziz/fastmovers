        ...
        <td rowspan="2">  
            ...
            <caption>
                ...
                <tr style="height: 35px; background-color: #000; color: #d43f3a; padding: 5px;">
                    ...
                    <th style="padding: 10px;">Booking Details</th>                    
                </tr>  
                ...
                <tr >
                    ...
                    <td>
                        <table> 
                            ...
                            <tr> 
                                <td colspan="2">
                                    <center> <a href="AdvanceAndBooking.jsp?siteID=<%=rs.getString("siteID")%>">
                                            <img src='../TemplateStyleFiles/ClickToPayAdvance.png' width="250" height="100" />
                                        </a>
                                </td>
                            </tr> 
                        </table>
