...
<%
    ...
    String query="SELECT status FROM tbl_site_register WHERE status =1 and userID="+id;
    
    ResultSet rs=obj.select(query);
    if(rs.first()){
    int c =Integer.parseInt( rs.getString(1));
    if (c>0){
        out.print("<script>alert('Site Verified, Please Pay the Advance')</script>");
        out.print("<script>window.location.href='SiteSeleter.jsp'</script>");
    }}
%>
<div class="hero" style="background-image: url('../TemplateStyleFiles/images/lead.jpg'); text-align:right;">
    <div class="hero-inner">
        <div class="inner">
            <h1><span class="border border-top border-bottom"><font color="red">itsy</font></span></h1>
            <div class="hero-line-one"></div>
            <div class="hero-line-two"><span class="border border-bottom"><a href="https://freehtml5.co" style="color:#FFF;"><font color="red">IT</font>s ea<font color="red">SY</font> to move</a></span></div>
        </div>
...
<div class="home-sticky" id="content">
    ...
    <h2 class="home-sticky-title">Moving Without the Hassle</h2> 
    ...
    <div class="sticky-inner">
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky">
  		    ...
  		    <span class="post-image">
  				<a href="#">
  				<img width="502" height="502" src="../TemplateStyleFiles/images/Lollipop-502x502.jpg"
            ...
            <div class="inner">
                ...
                <ul class="meta top">
                    <li class="time">
                        <a href="#">
                            <time class="post-date updated" datetime="2015-02-02">Safe and Secure</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky ">
            ...
            <span class="post-image">
  				<a href="#">
  				<img width="502" height="502" src="../TemplateStyleFiles/images/Apothecary.jpg"
                     class="attachment-sticky size-sticky" alt=""/>
  				</a>
  		    </span>
                    ...
                    <li class="time">
                        <a href="#"
                           title="The Apothecary">
                            <time class="post-date updated" datetime="2015-01-31">Do on Time</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky">
  		    ...
  		    <span class="post-image">
                <a href="#">
                    <img width="502" height="502" src="../TemplateStyleFiles/images/Flowers.jpg"
                     class="attachment-sticky size-sticky" alt=""/>
  				</a>
  		    </span>
            ...
            <div class="inner">
                <h3 class="entry-title">
                    <a href="#">Flat Shifting</a>
                </h3>

                <ul class="meta top">
                    <li class="time">
                        <a href="#">
                            <time class="post-date updated" datetime="2015-01-25">Shift Anywhere</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky ">
  		    ...
  		    <span class="post-image">
                <a href="#"><img width="502" height="502" src="../TemplateStyleFiles/images/Sun.jpg"
                     class="attachment-sticky size-sticky" alt=""/>
  				</a>
            </span>
            ...
            <div class="inner">
                ...
                <ul class="meta top">
                    <li class="time">
                        <a href="#"
                           title="The Sunny Day">
                            <time class="post-date updated" datetime="2015-01-21">January 21, 2020</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky ">
  		    ...
  		    <span class="post-image">
                <a href="#">
                    <img width="502" height="502" src="../TemplateStyleFiles/images/Meeting.jpg"
                     class="attachment-sticky size-sticky" alt=""/>
  				</a>
            </span>
            ...
            <div class="inner">
                <h3 class="entry-title">
                    <a href="#">Shifting with Responsibility</a>
                </h3>

                <ul class="meta top">
                    <li class="time">
                        <a href="#">
                            <time class="post-date updated" datetime="2015-01-02">January 2, 2020</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <aside class="home-sticky-post post has-post-thumbnail sticky ">
            ...
            <span class="post-image">
                <a href="#">
                    <img width="502" height="502" src="../TemplateStyleFiles/images/Bridge.jpg"
                     class="attachment-sticky size-sticky" alt=""/>
  				</a>
  		    </span>
            ...
            <div class="inner">
                <h3 class="entry-title">
                    <a href="#">Packing with Care</a>
                </h3>

                <ul class="meta top">
                    <li class="time">
                        <a href="#">
                            <time class="post-date updated" datetime="2014-12-31">December 31, 2020</time>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <section class="main main-archive">
            <div class="loop">
                ...
                <article class="post format-gallery post_format-post-format-gallery">
                    ...
                    <a href="#"
                       title="Fast Movers and Shifters">
                        <div class="part-gallery">
                            <div class="flexslider">
                                <ul class="slides">

                                    <li><span class="post-image"><img src="../TemplateStyleFiles/images/Run-3.jpg"
                                                                      alt="Run-3"/></span></li>
                                    <li><span class="post-image"><img src="../TemplateStyleFiles/images/Run-1.jpg"
                                                                      alt="Run-1"/></span></li>
                                    <li><span class="post-image"><img src="../TemplateStyleFiles/images/Run-2.jpg"
                                                                      alt="Run-2"/></span></li>
                                </ul>
                            </div>
                        </div>
                ...
                <article class="post format-image has-post-thumbnail post_format-post-format-image">
  		            ...
  		            <span class="post-image">
  			  				<a href="#" title="Camper Van Fun">
  			  				    <img width="916" height="611" src="../TemplateStyleFiles/images/Camper-1.jpg"
  		            ...
  		            <span class="post-image">
  			  				<a href="#" title="The Flower Shop">
  			  				    <img width="916" height="611"
                                     src="../TemplateStyleFiles/images/Flower-Shop.jpg"
                                     class="attachment-desktop size-desktop" alt=""/>
                            </a>
  		            </span>
