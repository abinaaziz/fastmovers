...
<div class="div_Heading" >
    <p class="align_center_p"> Profile</p>
</div>
        ...
        <div align="center" >        
             <table class="Content_Table">
               ...
               <tr><td>CONTACT NUMBER</td>
                   <td>
                          <input type="text" name="contactNumber" requird="" value="<%=contactNumber%>">  </td></tr>  
               <tr><td>MOBILE NUMBER</td>
                   <td>
                          <input type="text" name="mobileNumber" requird="" value="<%=mobileNumber%>">  </td></tr>  
               ...
               <tr><td>DATE OF BIRTH</td>
                   <td>
                       <input type="date" name="dateOfBirth" requird="" value="<%=dateOfBirth%>">
                   </td></tr>

               <tr>
                   <td>MARITAL</td>
                   <td>
                       <input type="text" name="marital" value="<%=maritalStatus%>"</td></tr>
               ...
               <tr><td>RECOVERY QUESTION</td>
                   <td>
                        <select  name="recoveryQuestion" >
                            <option >Select</option>
                            <option <%if(recoveryQuestion.equals("Favourite Color")){%> selected="select"<%}%>>Favourite Color</option>
