        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\User\\PondImages\\";
                    Random r=new Random();
            ...
            String columns="userID,pondCategoryID,pondImage,pondAria,farmBedAria,pondPlace,pondAddress,"
                    + "stateID,districtID,startDate,"
                    + "finishDate,currentDate"                    
                   ;  
            
            String queryInsert="insert into tbl_pond_register("+columns+") values ("+values1+")";
