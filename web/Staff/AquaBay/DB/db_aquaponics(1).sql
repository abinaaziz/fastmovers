...
CREATE TABLE IF NOT EXISTS `tbl_pond_mechanism_details` (
  ...
  `pondMechanismName` varchar(50) NOT NULL,
  `costOfMakingMechanism` varchar(50) NOT NULL,
  `discription` varchar(200) NOT NULL,
...
(1, 'Cemnt Tank', '500', 'Nil'),
(2, 'Cemnt Tank', '500', 'Nil'),
(3, 'Cemnt Tank', '500', 'Nil'),
(4, 'gg', '66', 'Nil');
...
(4, 1, 3, 'IMG_1261.jpg', '450', '300', 'Udumbannoor', 'Perum H', 1, 1, '2022-11-27', '2022-11-17', '2020/11/18', '0', 0);
...
CREATE TABLE IF NOT EXISTS `tbl_secondary_layer_details` (
  ...
  `costOfMakingSecondaryLayer` varchar(50) NOT NULL,
  `discription` varchar(200) NOT NULL,
