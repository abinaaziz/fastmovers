        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\Staff\\ProfilePictures\\";
                    Random r=new Random();
            ...
            + "pincode,district,state,gender,contactNumber,"
            + "mobileNumber,email,qualification,dateOfBirth,maritalStatus,"
            + "userName,password,recoveryQuestion,answer,staffCategoryID,"
            + "profilePicture";  
            String queryInsert="insert into tbl_staff_details("+columns+") values ("+values1+")";
