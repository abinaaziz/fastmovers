...
<div class="div_login">
    ...
    <table class="Round_corner_Form_Base">
        ...
        {           
            String queryDelete="delete from tbl_verified_fish_details where verifiedFishID="+did;
        ...
        {   
            ...
            String querySelect="select * from tbl_verified_fish_details where verifiedFishID="+eid;
            System.out.print("EDIT: eid="+eid);
            ResultSet rs=obj.select(querySelect);                
            if(rs.next())
            {
                fishID =rs.getString("fishID");
                countOfFishs =rs.getString("countOfFishs");
            } 
        }
        if (request.getParameter("B_Submit")!=null)
        {   
            System.out.print("Submit Button clicked in file LabTest Details"); 
            fishID =request.getParameter("fishID");
            countOfFishs =request.getParameter("countOfFishs");
            ...
            if (request.getParameter("eid") != null)
            {
                ...
                + "',fishID='" +fishID
                + "',countOfFishs='" +countOfFishs
                +"'" ;
                
                String queryUpadate = "update tbl_verified_fish_details set "+values2+ " where verifiedFishID=" + eid;  //EDIT
                System.out.print(queryUpadate);
                obj.executeCommand(queryUpadate);
            } 
            else  
            {                    
                String columns= "pondID, fishID, countOfFishs";
                String queryInsert="insert into tbl_verified_fish_details("+columns+") values ("+values1+")";
                                ...
                                <td style="vertical-align: top;">                                    
                                    <table class="Content_Table">
                                        <caption>
                                          ...
                                          <tr><td>Select Fish Type</td>

                                              <td>
                                                   <select name="fishID" >    
                                                       <option value="Nil">-------------Select-------------</option>
                                                        <%
                                                        String querySelect2 = "select * from tbl_fish_details "; 
                                                        ResultSet rs2 = obj.select(querySelect2);
                                                        System.out.print("XXXXXXXXXX "+querySelect2);
                                                        while (rs2.next()) 
                                                        {                                                
                                                        %>
                                                       <option value="<%=rs2.getString("fishID")%>"     
                                                       <%if(fishID.equals(rs2.getString("fishID")))
                                                        {
                                                       %>
                                                           selected="selected"
                                                       <%}%> >

                                                       <%=rs2.getString("fishName")%> 
                                                       </option>
                                                       <%
                                                       }
                                                       %>
                                           ...
                                           <tr>
                                              <td>count Of Fishs</td>
                                              <td>
                                                  <input type="text" name="countOfFishs" required="required" value="<%=countOfFishs%>" > 
                                              </td>
                                          </tr> 
                            ...
                            <tr>
                                ...
                                <tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="align-content: center; width:350px;">
                                                    ID:  <%=rs3.getString("fishID")%>
                                                 </td>
                                            </tr>
                                            <tr>
                                                <td style="align-content: center">
                                                   Fish Name:  <%=rs3.getString("fishName")%> 
                                                </td>    
                                            </tr>
                                            
                                            <tr>
                                                <td style="align-content: center">
                                                   Capacity: <%=rs3.getString("seedSize")%>
                                                </td>    
                                            </tr>
                                        </table>   
                                    </td>
                                     <td>
                                        <table>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td style="align-content: center; width:350px;">
                                                    No of Fishs: <%=rs3.getString("countOfFishs")%>
                                                 </td>
                                            </tr>
                                    ...
                                    <td style="align-content: center; vertical-align: middle;">
                                         Rs: <%=Float.parseFloat(rs3.getString("countOfFishs"))*Float.parseFloat(rs3.getString("sellingRate"))%>
                                    </td>  
                                        
                                    <td  style="width: 80px; vertical-align: middle"> <center><a href="FishVerification.jsp?eid=<%=rs3.getString("a.verifiedFishID")%>&pondID=<%=URLpondID%>"><img src="../TemplateStyleFiles/EditIcon.png" height="30px" width="30px"></a></td>
                                    <td  style="width: 80px; vertical-align: middle"> <center><a href="FishVerification.jsp?did=<%=rs3.getString("a.verifiedFishID")%>&pondID=<%=URLpondID%>"><img src="../TemplateStyleFiles/DeleteIcon.png" height="30px" width="30px"></a></td>
                                </tr>
                                <%
                                }
                                %>
