                ...
                <tr> 
                    <td colspan="3" >
                        <table style="width: 950px;" >  
                            <tr>          
                                <td >
                            <center> <a href="AssignWorker.jsp?siteID=<%=siteID%>"> <img src='../TemplateStyleFiles/AllotWorker.png' width="250" height="80" /></a>
                                </td>
                                <td >
                                <center> <a href="AssignVehicle.jsp?siteID=<%=siteID%>"> <img src='../TemplateStyleFiles/AllotVehicle.png' width="250" height="80" /></a>
                                </td>
                                <td >
                                    <center> <a href="ExpenceDetails.jsp?siteID=<%=siteID%>"> <img src='../TemplateStyleFiles/AllotVoucher.png' width="250" height="80" /></a>
                                </td>                                
                            </tr>
                        </table>   
                    </td> 
